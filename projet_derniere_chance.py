...
CYLINDRE = "cylindre"
CYLINDRE0 = "cylindre0"                           # MARINE : cylindre rouge
CAPTEUR = "distance_sensor"                       # capteur de distance
TARGET = "target"                                 # target dummy
SENSOR = "tool_detector"                          # MARINE : objets de la scène
TOOL = "tool"
...
giCylindre0 = -1                                  # MARINE : ID sur le handle du cylindre ROUGE pour estimer la distance du un premier temps
